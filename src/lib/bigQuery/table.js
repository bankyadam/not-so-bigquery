...
const pageResult = require('../db/pageResult');
const db = require('../db');
...
module.exports = class Table {
  ...
  async exists() {
    return await db.tableExists(this._dataset.internalId, this.internalId);
  }
  ...
  async fields() {
    const fields = await db.tableFields(this._dataset.internalId, this.internalId);
