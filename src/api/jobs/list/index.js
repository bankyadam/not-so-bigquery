 ...
 * available for a six month period after creation. The job list is sorted in reverse
 * chronological order, by job creation time. Requires the Can View project role, or
