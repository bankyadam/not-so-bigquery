...
describe('Query Translator', function() {
  ...
  describe('from clause', function() {
    describe('dataset handling', function() {
      ...
      it('surrounding with backticks', composeTestCase('from-clause-backtick-table-name'));
    });
  ...
  describe('special cases', function() {
    ...
    it('query expression inside query expression',
      composeTestCase('query-expression-inside-query-expression'));
  });
});
