...
describe('Query Translator', function() {
  ...
  describe('query syntax', function() {
    ...
    it('expression-array-of-integers', runExpectation(require('./testcases/expression-array-of-integers.txt')));
    it('expression-array-of-strings', runExpectation(require('./testcases/expression-array-of-strings.txt')));
    it('expression-array-of-booleans', runExpectation(require('./testcases/expression-array-of-booleans.txt')));
